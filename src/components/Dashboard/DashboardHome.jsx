...
const DashboardHome = () => {
    ...
    return (
        <div className="space-y-8 relative z-10">
            ...
            <div className="backdrop-blur-md bg-white/60 dark:bg-[#130E26]/60 border border-slate-200/50 dark:border-white/5 rounded-3xl p-6 md:p-8 flex flex-col md:flex-row items-center justify-between gap-6 shadow-xl">
                <div className="flex items-center gap-4 text-center md:text-left flex-col md:flex-row">
                    <img 
                        src={user?.photoURL || "https://daisyui.com/images/stock/photo-1534528741775-53994a69daeb.jpg"} 
                        alt={user?.displayName || "User"} 
                        className="w-16 h-16 rounded-full object-cover border-2 border-orange-500/80 p-0.5 shadow-md bg-white dark:bg-[#0B081A]"
                    />
                    <div>
                        <h2 className="text-2xl md:text-3xl font-black text-slate-800 dark:text-slate-100">
                            Welcome Back, <span className="text-gradient-orange">{user?.displayName || "Expert Fixer"}</span>!
                        </h2>
                ...
                <Link 
                    ...
                    className="px-5 py-3 bg-gradient-to-r from-orange-500 to-amber-600 hover:from-orange-600 hover:to-amber-700 text-white font-bold rounded-2xl shadow-lg shadow-orange-500/20 hover:scale-[1.03] active:scale-[0.98] transition-all text-sm flex items-center gap-2"
                >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                {/* Stat 1 */}
                <div className="backdrop-blur-md bg-white/40 dark:bg-[#130E26]/40 hover:bg-white/60 dark:hover:bg-[#130E26]/60 border border-slate-200/50 dark:border-white/5 rounded-2xl p-6 shadow-md transition-all duration-300 hover:scale-[1.02]">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className="lg:col-span-2 backdrop-blur-md bg-white/60 dark:bg-[#130E26]/60 border border-slate-200/50 dark:border-white/5 rounded-3xl p-6 md:p-8 space-y-6 shadow-xl">
                    <h3 className="text-lg md:text-xl font-extrabold text-slate-800 dark:text-slate-100 flex items-center gap-2">
                        <HiOutlineSparkles className="w-5 h-5 text-orange-500 animate-pulse" />
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        ...
                        <Link 
                            ...
                            className="p-5 rounded-2xl border border-slate-200 dark:border-white/5 hover:border-orange-500/20 bg-slate-50/50 dark:bg-white/5 hover:bg-orange-500/[0.02] dark:hover:bg-orange-500/[0.02] flex items-center justify-between group transition-all"
                        >
                            <div className="flex items-center gap-3.5">
                                <div className="p-2.5 rounded-xl bg-orange-500/10 text-orange-500 group-hover:scale-105 transition-transform">
                            ...
                            <HiOutlineArrowRight className="w-4 h-4 text-slate-400 group-hover:text-orange-500 group-hover:translate-x-1 transition-all" />
                        </Link>
                        ...
                        >
                            <div className="flex items-center gap-3.5">
                                <div className="p-2.5 rounded-xl bg-purple-500/10 text-purple-500 group-hover:scale-105 transition-transform">
                        ...
                        >
                            <div className="flex items-center gap-3.5">
                                <div className="p-2.5 rounded-xl bg-teal-500/10 text-teal-500 group-hover:scale-105 transition-transform">
                ...
                <div className="backdrop-blur-md bg-white/60 dark:bg-[#130E26]/60 border border-slate-200/50 dark:border-white/5 rounded-3xl p-6 md:p-8 space-y-5 shadow-xl">
                    ...
                    <div className="space-y-4 text-xs md:text-sm text-slate-600 dark:text-slate-400">
                        <div className="p-3.5 rounded-xl bg-orange-500/5 border border-orange-500/10">
                            <span className="font-bold text-orange-500 block">Fast Response times</span>
                        ...
                        <div className="p-3.5 rounded-xl bg-purple-500/5 border border-purple-500/10">
                            <span className="font-bold text-purple-500 block">Clear Diagnostic Outlines</span>
